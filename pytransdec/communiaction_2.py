...
from screenshotTaker import get_screenshot
	...
	with TransdecCommunication() as tc:
		...
		for i in range(0, 1):	
			...
			tc.collect_data(positive=False, add_noise=True, add_background=False, n_images=500, save_dir='collected_data/{}/valid'.format(i),
							used_observations='all', object_number=i, show_img=False, draw_annotations=True)
			'''
			tc.collect_data(positive=True, add_noise=True, add_background=False, n_images=45000, save_dir='collected_data/{}/train'.format(i),
							used_observations='all', object_number=i, show_img=False, draw_annotations=True)
			tc.collect_data(positive=False, add_noise=True, add_background=False, n_images=5000, save_dir='collected_data/{}/train'.format(i),
							used_observations='all', object_number=i, show_img=False, draw_annotations=True)
			tc.reset()
